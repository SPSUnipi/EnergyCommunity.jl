...
input_file = "energy_community_model.yml"  # Input file

output_file_isolated = "output_file_NC.xlsx"  # Output file - model users alone
output_plot_isolated = "Img/plot_user_{:s}_NC.png"  # Output png file of plot - model users alone

output_file_combined = "output_file_EC.xlsx"  # Output file - model Energy community
output_plot_combined = "Img/plot_user_{:s}_EC.pdf"  # Output png file of plot - model energy community

output_plot_sankey_agg = "Img/sankey_EC.png"  # Output plot of the sankey plot related to the aggregator case
output_plot_sankey_noagg = "Img/sankey_NC.png"  # Output plot of the sankey plot related to the no aggregator case


## Initialization

# Read data from excel file
model_ec = ModelEC(input_file)

set_group_type!(model_ec, GroupNC())

build_model!(model_ec)

optimize_model!(model_ec)
